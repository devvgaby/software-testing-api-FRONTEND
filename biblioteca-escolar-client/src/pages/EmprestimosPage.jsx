...
export function EmprestimosPage() {
  ...
  const livrosDisponiveis = livros.filter(
    (l) => (l.disponivel ?? 0) > 0 || (editando && l.id === editando.livro_id),
  );
              ...
              return (
                <div key={e.id} className="list-card">
                  <div className="list-card__top">
                    ...
                    <span
                      className={`badge ${ativo ? "badge--ok" : "badge--aluno"}`}
                    >
          ...
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h3 className="modal-title">
                {editando ? "Editar Empréstimo" : "Novo Empréstimo"}
              </h3>
              <button
            ...
            <form onSubmit={handleSalvar}>
              <div className="modal-body form-stack">
                <div className="form-field">
                  ...
                  <select
                    name="livro_id"
                    defaultValue={editando?.livro_id || ""}
                    required
                  >
                ...
                <div className="form-field">
                  ...
                  <select
                    name="usuario_id"
                    defaultValue={editando?.usuario_id || ""}
                    required
                  >
                ...
                <div className="form-field">
                  ...
                  <input
                    ...
                    defaultValue={
                      editando?.data_devolucao_prevista?.split("T")[0] || ""
                    }
                    required
                  />
                </div>
